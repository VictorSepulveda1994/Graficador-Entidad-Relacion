    ...
    public void moveElement(MouseEvent event, Canvas canvas, boolean showPoints, int minWidth, int minHeight){
        ...
        if( selectedElement != null && event.getX()-70 > 0  && event.getY()-40 > 0){
            ...
            if( "Entity".equals(type) ){
                ...
                relations.set(iElement, new Relation(selectedElement.name, selectedElement.figure.getSides(), (int)event.getX(), (int) event.getY(), selectedElement.selected,entitiesCopy,attributesCopy,((Relation)selectedElement).getType(),Cardinality.MANY_TO_MANY));
